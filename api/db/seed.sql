...
-- client_id is required because of UNIQUE NULLS NOT DISTINCT (school_id, client_id)
INSERT INTO grades (school_id, student_id, class_id, subject_id, teacher_id, school_year_id, semester, numeric_grade, grade_date, client_id) VALUES
    ('a0000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000201', 'f1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000011', 'e0000000-0000-0000-0000-000000000001', 'I', 9, '2026-10-05', 'c1000000-0000-0000-0000-000000000001'),
    ('a0000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000201', 'f1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000011', 'e0000000-0000-0000-0000-000000000001', 'I', 8, '2026-11-12', 'c1000000-0000-0000-0000-000000000002'),
    ('a0000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000201', 'f1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000012', 'e0000000-0000-0000-0000-000000000001', 'I', 10, '2026-10-10', 'c1000000-0000-0000-0000-000000000003'),
    ('a0000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000202', 'f1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000011', 'e0000000-0000-0000-0000-000000000001', 'I', 7, '2026-10-05', 'c1000000-0000-0000-0000-000000000004'),
    ('a0000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000203', 'f1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000012', 'e0000000-0000-0000-0000-000000000001', 'I', 6, '2026-10-10', 'c1000000-0000-0000-0000-000000000005');

-- Sample qualifiers for 2A (primary)
INSERT INTO grades (school_id, student_id, class_id, subject_id, teacher_id, school_year_id, semester, qualifier_grade, grade_date, client_id) VALUES
    ('a0000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000101', 'f1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000010', 'e0000000-0000-0000-0000-000000000001', 'I', 'FB', '2026-10-08', 'c1000000-0000-0000-0000-000000000006'),
    ('a0000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000102', 'f1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000010', 'e0000000-0000-0000-0000-000000000001', 'I', 'B', '2026-10-08', 'c1000000-0000-0000-0000-000000000007'),
    ('a0000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000103', 'f1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000010', 'e0000000-0000-0000-0000-000000000001', 'I', 'FB', '2026-10-15', 'c1000000-0000-0000-0000-000000000008');

-- Sample absences
INSERT INTO absences (school_id, student_id, class_id, subject_id, teacher_id, school_year_id, semester, absence_date, period_number, client_id) VALUES
    ('a0000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000203', 'f1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000011', 'e0000000-0000-0000-0000-000000000001', 'I', '2026-10-20', 3, 'c1000000-0000-0000-0000-000000000009'),
    ('a0000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000204', 'f1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000012', 'e0000000-0000-0000-0000-000000000001', 'I', '2026-11-03', 1, 'c1000000-0000-0000-0000-000000000010');
...
-- Grades for 10A
INSERT INTO grades (school_id, student_id, class_id, subject_id, teacher_id, school_year_id, semester, numeric_grade, grade_date, client_id) VALUES
    ('a0000000-0000-0000-0000-000000000002', 'b2000000-0000-0000-0000-000000000101', 'f2000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000002', 'b2000000-0000-0000-0000-000000000010', 'e0000000-0000-0000-0000-000000000002', 'I', 10, '2026-09-25', 'c2000000-0000-0000-0000-000000000001'),
    ('a0000000-0000-0000-0000-000000000002', 'b2000000-0000-0000-0000-000000000101', 'f2000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000002', 'b2000000-0000-0000-0000-000000000010', 'e0000000-0000-0000-0000-000000000002', 'I', 9, '2026-10-15', 'c2000000-0000-0000-0000-000000000002'),
    ('a0000000-0000-0000-0000-000000000002', 'b2000000-0000-0000-0000-000000000102', 'f2000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000001', 'b2000000-0000-0000-0000-000000000011', 'e0000000-0000-0000-0000-000000000002', 'I', 8, '2026-10-02', 'c2000000-0000-0000-0000-000000000003');
...
INSERT INTO grades (school_id, student_id, class_id, subject_id, teacher_id, school_year_id, semester, numeric_grade, is_thesis, grade_date, description, client_id) VALUES
    ('a0000000-0000-0000-0000-000000000001',
     ...
     'b1000000-0000-0000-0000-000000000011',
     'e0000000-0000-0000-0000-000000000001',
     'I', 7, true, '2027-01-15', 'Teză semestrială', 'c1000000-0000-0000-0000-000000000011');
