...
test('21 – teacher sees assigned class cards', async ({ teacherPage }) => {
  /**
...
test('22 – class card shows correct content (name, student count, education level)', async ({
  teacherPage,
}) => {
  /**
...
test('23 – clicking class card navigates to the catalog page for that class', async ({
  teacherPage,
}) => {
  /**
